...
//   bridge["nwk_addr"] = brigeNode.nwkAddr;
//   bridge["ieee_addr"] = String(brigeNode.macAddr, HEX);
//   bridge["pan_id"] = brigeNode.panId;
//   bridge["ex_pan_id"] = String(brigeNode.exPanId, HEX);
//   bridge["channel"] = brigeNode.channel;
...
//       device["ieee_addr"] = String(deviceList[i].u64IeeeAddr, HEX);
//       device["nwk_addr"] = deviceList[i].u16NwkAddr;
//       device["type"] = deviceList[i].u8Type;
//       device["modele_id"] = String((const char*)deviceList[i].au8ModelId);
//       device["vendor_id"] = String((const char*)deviceList[i].au8VendorId);
//     }
//   }
